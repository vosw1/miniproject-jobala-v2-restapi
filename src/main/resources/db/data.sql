...
values ('김주혁', 'cos1', 'cos@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, 'userImage (1).png',
        'userImage (1).png', now()),
       ('송민경', 'cos2', 'gook@nate.com', '1234', '부산광역시 해운대구', '1992-05-19', '01012345678', 0, 'userImage (2).png',
        'userImage (2).png', now()),
       ('박찬혁', 'cos3', 'ssar@nate.com', '1234', '서울시 황학구', '1997-07-23', '01022223333', 0, 'userImage (3).png',
        'userImage (3).png', now()),
       ('박선규', 'cos4', 'ssar@nate.com', '1234', '서울시 황학구', '1997-07-23', '01022223333', 0, 'userImage (4).png',
        'userImage (4).png', now()),
       ('장유진', 'cos5', 'ssar@nate.com', '1234', '서울시 황학구', '1997-07-23', '01022223333', 0, 'userImage (5).png',
        'userImage (5).png', now()),
       ('강호동', 'cos6', 'dong@nate.com', '1234', '부산광역시 기장군', '1995-04-17', '01012345678', 0, 'userImage (6).png',
        'userImage (6).png', now()),
       ('유재석', 'cos7', 'seok@nate.com', '1234', '부산광역시 ', '2000-04-25', '01012345678', 0, 'userImage (7).png',
        'userImage (7).png', now()),
       ('지석진', 'cos8', 'jin@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, 'userImage (8).png',
        'userImage (8).png', now()),
       ('송지효', 'cos9', 'ji@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, 'userImage (9).png',
        'userImage (9).png', now()),
       ('김종국', 'cos10', 'jong@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, 'userImage (10).png',
        'userImage (10).png', now()),
       ('양세찬', 'cos11', 'chan@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, 'userImage (11).png',
        'userImage (11).png', now());
...
values (1, '도전적인 프론트엔드 개발자 지원서', '프론트엔드', '신입', '정보처리기사',
       ...
       (9, '열정적인 프론트엔드 엔지니어 자기소개서', '백엔드', '신입', 'SQLD',
        ...
        '[Java, Spring, MySQL]', now()),
       (1, '열정적인 프론트엔드 엔지니어 자기소개서', '백엔드', '신입', 'SQLD',
        '안녕하세요, 열정적인 프론트엔드 엔지니어 김주혁입니다. 최신 웹 기술에 대한 지식과 열정으로 사용자들에게 최고의 경험을 제공하고자 합니다.', '고등학교 졸업',
        '[Java, Spring, MySQL]', now());
...
VALUES (12, '소프트웨어 개발자 채용', '신입', '고등학교 졸업', '백엔드', '서울', '정규직', '협의', '2024-12-31',
       ...
       (15, '마케팅 전문가 채용', '경력', '대학교 졸업', '백엔드', '부산', '정규직', '협의', '2024-09-30', '[JavaScript, HTML, MySQL]', 1,
        now()),
